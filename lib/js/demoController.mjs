...
import { getFromI18NConfigFull } from './typeSpec.mjs';
...
function selectTypeSpecByLanguage(typeSpecI18N, localeStr) {
    ...
    const [configLocale, columnConfig] = getFromI18NConfigFull(typeSpecI18N.columnConfigI18N, parseLocale(localeStr))
    return [configLocale, {
        columnConfig
